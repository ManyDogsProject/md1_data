...
```{r countries, fig.align="center", out.width="100%", fig.cap="ManyDogs 1 data presented here were collected from 20 research sites in eight countries: Argentina, Canada, Croatia, Hungary, Italy, Poland, UK, USA (dark blue). Pilot data not included in this dataset were collected from a site in Austria (light blue)."}
